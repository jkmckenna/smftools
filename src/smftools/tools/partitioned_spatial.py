...
def execute_partitioned_spatial(spine_path, cfg, output_dir) -> dict[str, Path]:
    ...
    # generation is published, matching hmm, latent, raw, and preprocess. Doing
    # it here would union a still-staged generation into the experiment spine
    # and leave it referenced even if validation then rejected the generation.
