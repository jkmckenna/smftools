...
def pod5_to_adata(config_path):
    ...
    pod5_dir = var_dict.get('pod5_dir', np.nan)
    output_directory = var_dict.get('output_directory', np.nan)
    output_pod5 = var_dict.get('output_pod5', np.nan)
    ...
    model = var_dict.get('model', np.nan)
    barcode_kit = var_dict.get('barcode_kit', np.nan) 
