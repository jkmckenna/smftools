"""Legacy matrix-CNN implementation retained behind compatibility adapters.

New code should use the manifest-bound training, inference, and interpretability
services. This module is internal and will be removed with the public legacy
adapters in smftools 3.0.
"""
