"""Legacy per-feature attribution implementations for fitted classifiers.
...
the legacy matrix-CNN adapter since it needs the CNN's
channel-encoded input and trained-model wrapper, not a sklearn Pipeline.
These implementations are internal compatibility code. Canonical explanation
execution lives under :mod:`smftools.machine_learning.interpretability`.
"""
