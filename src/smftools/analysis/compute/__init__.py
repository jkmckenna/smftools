...
Modules
-------
autocorrelation         binary_autocorrelation_with_spacing(), compute_replicate_curve(), compute_single_molecule_periodicity(), compute_single_molecule_periodicity_direct()
...
ls_periodicity          analyze_ls_periodicity(), analyze_ls_periodicity_direct(), ls_periodogram_from_autocorr(), ls_periodogram_from_signal(), analyze_fft_periodicity()
dimensionality_reduction  run_pipeline(), coverage_filter(), make_features_acf(), umap_from_pca(), cluster_from_pca()
