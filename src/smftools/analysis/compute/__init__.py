...
autocorrelation         binary_autocorrelation_with_spacing(), compute_replicate_curve(),
                        compute_single_molecule_periodicity(),
...
ls_periodicity          analyze_ls_periodicity(), analyze_ls_periodicity_direct(),
                        ls_periodogram_from_autocorr(), ls_periodogram_from_signal(),
